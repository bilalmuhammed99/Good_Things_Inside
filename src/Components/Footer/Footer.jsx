...
const Footer = () => {
  return (
    <> 
    <div className='footer text-light my-5 p-5 justify-content-center footer align-items-center  d-flex'>
        <div className='content text-center'><h3>Subscribe on GTI Stores now!</h3>
        ...
        <div className='form d-flex justify-content-between'>
             <input type="email" className="form-control w-50 bg-light " id="exampleFormControlInput1" placeholder="name@example.com" />
        <div className='btn btn-light text-light w-25'> SUBSRIPE  </div>
        </div>
        </div>
